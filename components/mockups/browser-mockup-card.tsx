...
export function BrowserMockupCard({
  ...
  return (
    <div
      ...
      className={cn(
        "w-full overflow-hidden rounded-[10px] border border-line bg-white",
        className,
      )}
      {...props}
    >
      <div className="flex items-center gap-2 border-b border-line bg-[#f1f0ed] px-3 py-2">
        ...
        <div className="flex h-5 min-w-0 flex-1 items-center rounded-md border border-line/70 bg-white px-2">
          <span className="truncate font-mono text-[10px] text-ink/45">{url}</span>
        </div>
      </div>
